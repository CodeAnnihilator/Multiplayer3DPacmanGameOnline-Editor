...
export default class Pacman extends Component {
  ...
  move = () => {
    this.setState({ pos: this.state.pos + 0.01 })
  ...
  render() {
    ...
    return (
      <group>
        ...
        <mesh rotation={new Euler(2, 0, 0)} scale={new Vector3(0.0035, 0.0035, 0.0035  )} position={new Vector3(this.state.x - 0.16, this.state.y - 0.4, 0.2)}>
          <geometryResource resourceId="pacmanGeometry" />
